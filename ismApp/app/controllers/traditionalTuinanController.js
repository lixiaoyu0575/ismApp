...
angular.module("app").controller("traditionalTuinanController", ["traMedical","medicalKnowledgeModal","$scope",
  "$rootScope","$state",function (traMedical,medicalKnowledgeModal,$scope,$rootScope,$state, $location) {
