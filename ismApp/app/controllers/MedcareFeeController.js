...
(function () {
    ...
    /* @ngInject */
    function MedcareFeeController($scope,$rootScope, $location,$http) {
        var vm = $scope.vm = {};

        $http.get('http://59.110.52.133:3010/api/transfer/?q={"path":"/medcareFee/getUserItems","params":{%22PID%22:%22ZY010001102284%22}}'
        ...
        vm.confirm = function (id) {
            ...
            $.ajax({
                url:"http://59.110.52.133:9999/medcareFee/updateUserItems/",
                type: "POST",
